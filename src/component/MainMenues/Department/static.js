...
export const DepartmentList = [Elective, HRD, MechanicalEngineerging,DesignArchitecturalEngineering, MechatronicsEngineering, IndustrialManagement, EnergyNewMaterialsChemicalEngineering, ElectricalElectronicCommunication, ComputerEngineering, Fusion]
export const DepartmentNameList = ['교양학부','HRD학과','기계공학부','디자인 건축 공학부','메카트로닉스공학부','산업경영학부','에너지신소재화학공학부','전기전자통신공학부','컴퓨터공학부','융합학과']